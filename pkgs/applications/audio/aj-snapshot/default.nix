...
stdenv.mkDerivation rec {
  ...
  meta = with stdenv.lib; {
    ...
    longDescription = ''
      ...
      connections made between JACK and/or ALSA clients.  Because JACK can
      ...
      provides routing facilities for MIDI clients.  You can also run
      aj-snapshot in daemon mode if you want to have your connections
